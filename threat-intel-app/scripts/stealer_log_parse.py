#!/usr/bin/env python3
# Adapted from 7onez/cti-expert (MIT, Copyright 2026 Hieu Ngo / chongluadao.vn).
# Operator-runnable CLI; intentionally NOT wired into /api/analyze because
# infostealer logs contain third-party PII that the platform's no-persistence
# policy treats as too sensitive to pass through the SSE stream + bounded
# in-memory stores. Run from a workstation with appropriate handling controls.
#   python scripts/stealer_log_parse.py <log-folder> [out-dir]
"""
